...
/* Generated by Opal 0.8.0 */
Opal.modules["opal-haml"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass;

  Opal.add_stubs(['$require', '$each', '$update', '$collect', '$==', '$join']);
  ...
  return (function($base, $super) {
    ...
    return (function($base, $super) {
      ...
      return (def.$attributes = function(class_id, obj_ref, attributes_hashes) {
        ...
        attributes = class_id;
        ($a = ($b = attributes_hashes).$each, $a.$$p = (TMP_1 = function(hash){var self = TMP_1.$$s || this;
if (hash == null) hash = nil;
        return attributes.$update(hash)}, TMP_1.$$s = self, TMP_1), $a).call($b);
        result = ($a = ($c = attributes).$collect, $a.$$p = (TMP_2 = function(attr, value){var self = TMP_2.$$s || this;
...
/* Generated by Opal 0.8.0 */
Opal.modules["views/example.haml"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var $a, $b, TMP_1, self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $range = Opal.range;

  Opal.add_stubs(['$require', '$new', '$<<', '$join', '$map', '$**']);
  self.$require("opal-haml");
  return ($a = ($b = $scope.get('Template')).$new, $a.$$p = (TMP_1 = function(_hamlout){var self = TMP_1.$$s || this, $a, $b, TMP_2;
if (_hamlout == null) _hamlout = nil;
  _hamlout['$<<']("<h1>\nThis is a template.\n</h1>\n<h2>\nYou can put more templates in this app/views folder, and include them from opal by doing\n</h2>\n<pre>Template['views/templatename.haml'].render()</pre>\n<p>\nOf course, you can evaluate Ruby code here:\n</p>\n<p>\n" + (($a = ($b = ($range(1, 10, false))).$map, $a.$$p = (TMP_2 = function(x){var self = TMP_2.$$s || this;
if (x == null) x = nil;
    return x['$**'](2)}, TMP_2.$$s = self, TMP_2), $a).call($b).$join("---")) + "\n</p>\n<hr>\n<p>\nIt's also possible to pass an object to render, which can then be referenced as \"self\" from within the .haml view.\n</p>\n");
    return _hamlout.$join();}, TMP_1.$$s = self, TMP_1), $a).call($b, "views/example.haml");
};
...
(function(Opal) {
  ...
  Opal.add_stubs(['$require', '$require_tree', '$ready?', '$puts', '$inspect', '$[]', '$html', '$find', '$render']);
  self.$require("opal");
  self.$require("opal-jquery");
  self.$require("opal-haml");
  self.$require_tree("helpers");
  self.$require_tree("models");
  self.$require_tree("controllers");
  self.$require_tree("views/*");
  self.$require("views/example.haml");
  return ($a = ($b = $scope.get('Document'))['$ready?'], $a.$$p = (TMP_1 = function(){var self = TMP_1.$$s || this;

  self.$puts($scope.get('Template')['$[]']("views/example.haml").$inspect());
    return $scope.get('Element').$find("body").$html($scope.get('Template')['$[]']("views/example.haml").$render());}, TMP_1.$$s = self, TMP_1), $a).call($b);
})(Opal);
